...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    insertTag: function insertTag(e) {
      ...
      axios.post('/api/tag', myData).then(function (response) {
        _this.tags.push({
          id: response.data.id,
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "input-group-prepend col-2" }, [
      _c("span", { staticClass: "input-group-text w-100" }, [_vm._v("Tag")])
    ])
  }
]
...
/***/ 1:
/*!************************************************!*\
  !*** multi ./resources/js/components/Tags.vue ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/serveruser/www/resources/js/components/Tags.vue */"./resources/js/components/Tags.vue");
