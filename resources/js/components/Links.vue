	...
	<div>
		...
		<div class="input-group mb-3 no-gutters">
			<div class="col-lg-4 col-12">
				...
				<input type="text" max="255" v-model="link.name" class="form-control px-2"
					   id="name" maxlength="30" name="name" placeholder="Τίτλος">
			</div>

			<div class="col-lg-4 col-12">
				<label class="sr-only" for="url">Url</label>
				<input type="text" max="255" v-model="link.url" class="form-control px-2"
					   id="url" name="url" placeholder="Url">
			</div>

			<span class="btn btn-success col-lg-4 col-12" @click="insertLink">Προσθήκη</span>
